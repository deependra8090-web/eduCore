...
function Buy() {
  ...
  const token = storedUser?.token; // using optional chaining to avoid crash if missing
  const user = storedUser?.user; // actual user profile object
  ...
  const handlePurchase = async (event) => {
    ...
    if (confirmError) {
      ...
      await axios
        .post(`${API_BASE}/order`, paymentInfo, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
