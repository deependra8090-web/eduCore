...
function Signup() {
  const [firstName, setFirstName] = useState("");//value stored in firstname
...
//on typing in the input field, the value of the input field will be stored in the database
// e for event in frontend  
const handleSubmit = async (e) => {
    e.preventDefault();// value of the input field will be stored in the database and page will not be refreshed
